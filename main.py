...
def run_pipeline(
    folder_path="sample_files", scan_cloud=True, scan_s3=True, scan_local=True
):
...
if __name__ == "__main__":
    ...
    print_flush(
        f"Debug - scan_s3={scan_s3}, scan_local={scan_local}, scan_cloud={scan_cloud}"
    )
    ...
    if len(final_state["enriched_findings"]) > 0:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print_flush(
                    "Database creation failed. Run manually: python create_db.py"
                )
